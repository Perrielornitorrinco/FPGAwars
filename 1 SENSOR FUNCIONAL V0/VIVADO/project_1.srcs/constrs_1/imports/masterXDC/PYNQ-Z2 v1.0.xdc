...
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports {spi_rtl_io1_io}]; #IO_L8P_T1_34 Sch=jb_p[1] MISO
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports {spi_rtl_io0_io}]; #IO_L8N_T1_34 Sch=jb_n[1] MOSI
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports {spi_rtl_sck_io}]; #IO_L1P_T0_34 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports {spi_rtl_ss_io}]; #IO_L1N_T0_34 Sch=jb_n[2]
...
#set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports {spi_rtl_ss_o[0]}]; #IO_L21N_T3_DQS_34 Sch=ar[9] spi_rtl_ss_io[0
#set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports {spi_rtl_sck_o}]; #IO_L9P_T1_DQS_34 Sch=ar[10]   
#set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports {spi_rtl_io1_i}]; #IO_L19N_T3_VREF_34 Sch=ar[11] miso
#set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports {spi_rtl_io0_o}]; #IO_L23N_T3_34 Sch=ar[12] mosi
